...
function initThreeHero() {
  ...
  const initW = canvas.parentElement.offsetWidth  || window.innerWidth;
  const initH = canvas.parentElement.offsetHeight || window.innerHeight;
